...
// Service is the keyring service name under which all profile API keys are stored.
// The keyring "account" is the profile name.
const Service = "groundcover-cli"
...
// When false, callers should fall back to the GROUNDCOVER_API_KEY env var.
func Available() bool {
	const probe = "__groundcover_probe__"
